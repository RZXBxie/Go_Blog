...
CREATE TABLE `advertisements` (
  ...
  CONSTRAINT `fk_advertisements_image` FOREIGN KEY (`ad_image`) REFERENCES `images` (`path`)
...
CREATE TABLE `comments` (
  ...
  CONSTRAINT `fk_comments_children` FOREIGN KEY (`p_id`) REFERENCES `comments` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `friend_links` (
  ...
  CONSTRAINT `fk_friend_links_image` FOREIGN KEY (`logo`) REFERENCES `images` (`path`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `images` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uni_images_path` (`path`),
...
CREATE TABLE `users` (
  ...
  `address` longtext,
  `signature` varchar(191) DEFAULT '这位用户有点低调，未设置任何签名',
...
INSERT INTO `users` VALUES (1,'2025-04-21 19:12:05.622','2025-04-21 19:12:05.622',NULL,'00f5b41a-e359-4f6a-b25c-599d561e2b8f','昵称','$2a$10$mANSGkBeXJt4zZ5qIRsM6.n.SFxMNn60GmWDR7SdGce9psdJCxCOi','2545147971@qq.com','','/images/avatar.png','地址','这位用户有点低调，未设置任何签名',2,0,0);
...
-- Dump completed on 2025-04-21 11:42:38
